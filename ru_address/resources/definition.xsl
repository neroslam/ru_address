...
<!--                    <xsl:text>)</xsl:text>-->
                ...
                <xsl:when test="xs:simpleType/xs:restriction/@base='xs:byte'">INT</xsl:when>
...
<!--        &lt;!&ndash; End of column definitions &ndash;&gt;-->
<!--        <xsl:text>&#xa;) ENGINE = MyISAM </xsl:text>-->

<!--        &lt;!&ndash; Table comment &ndash;&gt;-->
